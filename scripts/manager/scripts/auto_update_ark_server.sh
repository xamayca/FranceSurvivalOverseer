...
auto_update_ark_server(){
  ...
  if [ "$server_build_id" -eq "$latest_build_id" ]; then
    ...
    local messages=(
      "LE SERVEUR ARK VA REDEMARRER DANS 10 MINUTES POUR MISE À JOUR..."
      "LE SERVEUR ARK VA REDEMARRER DANS 5 MINUTES POUR MISE À JOUR..."
      "LE SERVEUR ARK VA REDEMARRER DANS 1 MINUTE POUR MISE À JOUR..."
      "LE SERVEUR ARK VA REDEMARRER DANS QUELQUES SECONDES POUR MISE À JOUR..."
