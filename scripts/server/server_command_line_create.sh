...
server_command_line_create() {
  ...
  local query_params=(
    ...
    "CraftingSpeedMultiplier=$CRAFTING_SPEED_MULTIPLIER"
    ...
    "HarverstXPMultiplier=$HARVERST_XP_MULTIPLIER"
    ...
    "GlobalSpoilTimeMultiplier=$GLOBAL_SPOIL_TIME_MULTIPLIER"
    ...
    "NoTributeDownloads=$NO_TRIBUTE_DOWNLOAD"
  ...
  local simple_flag_params=(
    "UseDynamicConfig=$USE_DYNAMIC_CONFIG"
