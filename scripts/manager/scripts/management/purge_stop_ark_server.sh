...
purge_stop_ark_server(){
  ...
  log "[WARNING] DÉSACTIVATION DE LA PURGE PVP SUR LE SERVEUR ARK $SERVER_SERVICE_NAME..."
  ...
  log "[LOG] REDÉMARRAGE DU SERVICE $SERVER_SERVICE_NAME POUR DESACTIVATION DE LA PURGE..."
