...
restart_ark_server() {
  ...
  local messages=(
    "LE SERVEUR ARK VA REDEMARRER DANS 10 MINUTES POUR MAINTENANCE..."
    "LE SERVEUR ARK VA REDEMARRER DANS 5 MINUTES POUR MAINTENANCE..."
    "LE SERVEUR ARK VA REDEMARRER DANS 1 MINUTE POUR MAINTENANCE..."
    "LE SERVEUR ARK VA REDEMARRER DANS QUELQUES SECONDES POUR MAINTENANCE..."
